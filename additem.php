...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql = "INSERT INTO `allproduct` (`Title`, `modal`, `price`, `image`, `battery`, `capacity`, `weight`, `heat`, `descc`) VALUES ('$title', '$modal', '$price','$image', '$battery', '$capacity', '$weight', '$heat', '$desc');";
