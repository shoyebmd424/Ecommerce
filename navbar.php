            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="flex-wrap: wrap;">
                    ...
                    if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
                        ...
                        <li class="d-flex"> <p class="text-dark text-center  my-0 mx-2">Welcome ' . $_SESSION['username'] . '</p>
               <a href="/EV_Site/logout.php" class="btn btn-success ml-2">Logout</a> </li>';
                ...
                <li> <button type="button" class="btn loginbtn   py-2  btn-primary" data-bs-toggle="modal" data-bs-target="#loginmodal">
                Login
                </button></li>
